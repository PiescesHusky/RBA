...
def build_encoder(opt, embeddings, embeddings_latt = False):
    """
    ...
    if opt.encoder_type == "transformer":
        if embeddings_latt != False:  #latt
            return TransformerEncoder(opt.enc_layers, opt.rnn_size,
                                      ...
                                      opt.dropout, embeddings, embeddings_latt) #latt
        else:
            return TransformerEncoder(opt.enc_layers, opt.rnn_size,
                                      opt.heads, opt.transformer_ff,
                                      opt.dropout, embeddings, embeddings_latt) #latt
...
#latt  
        if model_opt.feat_merge == 'latt':
          #  src_embeddings, src_embeddings_latt = build_embeddings(model_opt, src_dict, feature_dicts)
            ...
            src_embeddings = build_embeddings(model_opt, src_dict, feature_dicts)
        #src_embeddings = build_embeddings(model_opt, src_dict, feature_dicts) #original
    #    print('src_embeddings', src_embeddings)
        encoder = build_encoder(model_opt, src_embeddings, src_embeddings_latt)
 #latt
